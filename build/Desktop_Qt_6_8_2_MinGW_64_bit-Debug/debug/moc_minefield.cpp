...
static constexpr auto qt_meta_stringdata_ZN9MineFieldE = QtMocHelpers::stringData(
    "MineField"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9MineFieldE[] = {
...
Q_CONSTINIT const QMetaObject MineField::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9MineFieldE.offsetsAndSizes,
    qt_meta_data_ZN9MineFieldE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9MineFieldE_t,
        // Q_OBJECT / Q_GADGET
...
void *MineField::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9MineFieldE.stringdata0))
